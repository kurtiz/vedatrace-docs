      ...
      <main className="text-landing-foreground pt-4 pb-6 dark:text-landing-foreground-dark md:pb-12">
        ...
        <div className="grid grid-cols-1 gap-10 mt-12 px-6 mx-auto w-full max-w-350 md:px-12 lg:grid-cols-2">
          <p className="text-2xl tracking-tight leading-snug font-light col-span-full md:text-3xl xl:text-4xl">
            ...
            Bringing powerful distributed tracing capabilities with SDKs for Python, JavaScript/TypeScript, and Dart.
          </p>
          ...
          <div className="rounded-2xl text-sm bg-origin-border shadow-lg bg-brand-secondary text-brand-secondary-foreground relative p-0">
            ...
            <div className="group flex overflow-hidden [--duration:40s] [--gap:1rem] gap-(--gap) flex-row p-8">
              <div className="flex shrink-0 justify-around gap-(--gap) animate-marquee flex-row">
                <div className="flex flex-col rounded-xl border bg-fd-card text-landing-foreground p-4 shadow-lg w-[320px]">
                  ...
                  <div className="mt-auto flex flex-row items-center gap-2 pt-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-fd-muted-foreground">Senior Engineer at TechCorp</p>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col rounded-xl border bg-fd-card text-landing-foreground p-4 shadow-lg w-[320px]">
                  <p className="text-sm whitespace-pre-wrap">
                    Finally, a tracing solution that doesn't require complex setup. VedaTrace's intuitive API and
                ...
                <div className="flex flex-col rounded-xl border bg-fd-card text-landing-foreground p-4 shadow-lg w-[320px]">
                  <p className="text-sm whitespace-pre-wrap">
                    The JavaScript SDK is fantastic! It works great with our Node.js backend and frontend applications.
                ...
                <div className="flex flex-col rounded-xl border bg-fd-card text-landing-foreground p-4 shadow-lg w-[320px]">
                  <p className="text-sm whitespace-pre-wrap">
                    As a Dart/Flutter developer, finding a good tracing library was challenging. VedaTrace's Dart SDK is
          ...
          <div className="rounded-2xl text-sm bg-origin-border shadow-lg bg-brand-secondary text-brand-secondary-foreground flex items-center justify-center p-0">
            <div className="relative grid">
              <div className="absolute flex flex-row left-1/2 -translate-1/2 bottom-0 z-2 p-0.5 rounded-full bg-fd-card border shadow-xl">
                ...
                ></div>
                <button className="w-20 h-8 text-sm font-medium transition-colors rounded-full text-fd-primary-foreground">
                  Docs
                </button>
                <button className="w-20 h-8 text-sm font-medium transition-colors rounded-full text-fd-muted-foreground">
                  API
                </button>
                <button className="w-20 h-8 text-sm font-medium transition-colors rounded-full text-fd-muted-foreground">
                  Examples
          ...
          <div className="rounded-2xl text-sm p-6 bg-origin-border shadow-lg border bg-fd-card flex flex-col">
            ...
            <p className="mb-4">
              VedaTrace provides simple, intuitive SDKs for all major platforms, with built-in support for OpenTelemetry
              standards.
            </p>
            <p className="mb-4">
              Get started in minutes with our comprehensive documentation and examples for Python, JavaScript/TypeScript,
              and Dart.
            </p>
            <Link
              to="/docs/$"
          ...
          <div className="col-span-full my-20">
            ...
            <div aria-hidden="false" className="animate-fd-fade-in">
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                <div className="bg-fd-card rounded-xl shiki relative border shadow-sm not-prose overflow-hidden text-sm">
                  ...
                  <div className="text-[0.8125rem] py-3.5 overflow-auto max-h-150 fd-scroll-container">
                    <pre className="min-w-full w-max *:flex *:flex-col shiki shiki-themes github-light github-dark">
                      <code>
                        <span className="line">
                          <span style={{ '--shiki-light': '#005CC5', '--shiki-light-font-weight': 'bold', '--shiki-dark': '#79B8FF', '--shiki-dark-font-weight': 'bold' }}>
                            # Python SDK
                          </span>
                        </span>
                        <span className="line">
                        ...
                        <span className="line">
                          ...
                          <span style={{ '--shiki-light': '#D73A49', '--shiki-dark': '#F97583' }}>=</span>
                          <span style={{ '--shiki-light': '#032F62', '--shiki-dark': '#9ECBFF' }}>&quot;my-python-app&quot;</span>
                        ...
                        <span className="line">
                          ...
                          <span style={{ '--shiki-light': '#032F62', '--shiki-dark': '#9ECBFF' }}>&quot;hello-world&quot;</span>
                          <span style={{ '--shiki-light': '#24292E', '--shiki-dark': '#E1E4E8' }}>):</span>
                        </span>
                        <span className="line">
                ...
                <div className="max-lg:row-start-1">
                  ...
                  <p>
                    The Python SDK provides a simple, intuitive API for distributed tracing with OpenTelemetry support.
                  </p>
          ...
          <div className="rounded-2xl text-sm p-6 bg-origin-border shadow-lg border bg-fd-card flex flex-col items-center text-center col-span-full">
